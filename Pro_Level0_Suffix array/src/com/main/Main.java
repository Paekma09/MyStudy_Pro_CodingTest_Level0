...
public class Main {
	...
	"programmers"	["ammers", "ers", "grammers", "mers", "mmers", "ogrammers", "programmers", 
	...
	입출력 예 #2
		예제 2번의 my_string는 "programmers"이고 모든 접미사는 "programmers", "rogrammers", 
		"ogrammers", "grammers", "rammers", "ammers", "mmers", "mers", "ers", "rs", "s"입니다. 
	...
	*/
	...
	public static String[] solution(String my_string) {
		// substring으로 잘라낸 문자열 저장하기 위한 List 생성
        List<String> list = new ArrayList<>();
        // substring으로 잘라낸 문자열 list에 저장
        for(int i=0; i<my_string.length(); i++) {
        	list.add(my_string.substring(i));
        }
        // 사전식 정렬
        Collections.sort(list);
        // list를 String 배열로 변환하여 저장 toArray 메소드 활용
